...
export class UserAuthenticationService {
  static async login(redirectUri = 'http://localhost:5173') {
    const authUrl = `https://${VITE_AUTH0_DOMAIN}/authorize?audience=${VITE_AUTH0_AUDIENCE}&response_type=code&client_id=${VITE_AUTH0_CLIENT_ID}&redirect_uri=${redirectUri}`;
